...
Icon checkDoorIcon(String statusString) {
  ...
  if (doorStatus == 0) {
    return const Icon(LiftDoorApp.open, size: 45, color: Color.fromARGB(255, 0, 0, 0),);
  } else if (doorStatus == 1) {
    return const Icon(LiftDoorApp.close, size: 45, color: Color.fromARGB(255, 0, 0, 0));
  } else if (doorStatus == 2) {
    return const Icon(LiftDoorApp.closing, size: 45, color: Color.fromARGB(255, 0, 0, 0));
